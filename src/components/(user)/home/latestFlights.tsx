      ...
      <div className="w-full max-w-5xl flex justify-center gap-5 flex-wrap ">
        {flights.flights.map((flight: any) => (
          <Link
            ...
            className=" hover:to-[#64748b8c] cursor-pointer min-h-[82px] rounded-md relative mt-4 flex flex-wrap flex-1 min-w-44 max-w-72 px-8 py-14 justify-between items-center bg-gradient-radial from-blue-100  to-indigo-100 shadow-2xl border-2 border-slate-300"
            key={flight.id}
