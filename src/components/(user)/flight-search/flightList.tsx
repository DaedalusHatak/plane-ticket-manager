    ...
    return (
      <>
        ...
        >
          ...
          <div className=" w-full flex-grow h-full  py-5 px-[5%] overflow-hidden">
            {connections.map((connection: any) => (
              <div
                className="hover:to-[#64748b8c] cursor-pointer relative mt-4 flex w-full py-2 sm:py-3 justify-between items-center bg-gradient-radial from-blue-100  to-indigo-100 shadow-lg border-2 border-slate-300 min-h-[82px] rounded-md"
                key={connection.id}
                onClick={(e) => setForward(connection.tickets_name)}
              >
