...
export default function ShowList({
	...
	return (
		<div className="w-full  max-h-[540px] mt-4 grid grid-cols-[50%,50%] sm:grid-cols-[1fr,40%] lg:grid-cols-[1fr,30%] rounded-[3px] bg-slate-300">
			<ul
				className={`relative ${
					allAirports ? 'pt-12' : 'pt-1'
				} max-h-[540px] flex overflow-y-scroll flex-row flex-wrap py-4 px-2 `}
			>
