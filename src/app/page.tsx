...
export default async function Home() {
  ...
  const { rows: flights } = await sql`SELECT * from flights order by id desc limit 5`;
  return (
    <main className="flex text-black relative min-h-screen flex-col items-center  overflow-x-hidden ">
     <div className="bg-blue-200  flex items-center text-black w-svw left-0 flex-col px-12 py-6">
     <h1 className="text-4xl w-full max-w-5xl text-left font-semibold">Find connection</h1>
    ...
    <h1 className="text-4xl pt-28 w-full max-w-5xl font-semibold">Latest flights</h1>
     <LatestFlights flights={flights}/>
    </div>
    <div>
    <h1 className="text-4xl w-full max-w-5xl font-semibold mt-28 mb-5 px-12">Why choose KicAir</h1>
